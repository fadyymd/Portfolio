        ...
        <div className="footer-top">
          ...
          <div className="fb">
            <div className="fb-logo">
              <span className="fbl-box">F</span>adi<span className="fbl-dot">.</span>dev
            </div>
          ...
          <div className="fc">
            ...
            <span className="fc-flag">🇩🇿 Algiers, Algeria</span>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="fb-socials">
            {[
              ...
              {href:'mailto:fadi.medkour@email.com',title:'Email',icon:<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="15" height="15"><rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="2,4 12,13 22,4"/></svg>},
