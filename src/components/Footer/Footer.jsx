    ...
    <footer className="footer">
      ...
      <div className="footer-inner">
        <div className="footer-top">
          {/* Brand — no text logo, just description */}
          <div className="fb">
            <div className="fb-brand">
              {/* Animated logo mark only — no text */}
            ...
            <p>{lang === 'ar'
              ? 'مطوّر Full Stack محترف متخصص في بناء تجارب رقمية عالية الأداء بأحدث التقنيات.'
              : 'Professional Full Stack Developer dedicated to crafting high-performance digital experiences with cutting-edge technology.'
            }</p>
          ...
          <div className="fb-socials">
            {[
              ...
              { href:'https://linkedin.com/in/fadi-medkour', title:'LinkedIn',
                icon:<svg viewBox="0 0 24 24" fill="#0A66C2" width="15" height="15"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg> },
              { href:'mailto:twwityh@gmail.com', title:'Email',
                icon:<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="15" height="15"><rect x="2" y="4" width="20" height="16" rx="2"/><polyline points="2,4 12,13 22,4"/></svg> },
              { href:'#hero', title:'Top',
                icon:<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" width="15" height="15"><path d="M12 19V5M5 12l7-7 7 7"/></svg> },
